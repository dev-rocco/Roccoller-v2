...
function makeText()
{
    ...
    tempText.style = "position:fixed; white-space:nowrap; color:"+configContents.textColour+"; font-family:"+configContents.fontFamily+"; font-size:"+configContents.fontSize+"px; margin:"+configContents.margin+"px;";
